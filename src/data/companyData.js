export const COMPANY_PROFILE = {
  ...
  tagline: "Sovereign Heritage & Royal Pilgrimage Infrastructure Since 2001",
  stats: [
    ...
    { value: "4 Sacred", label: "Riverfront Circuits Mastered", detail: "Godavari, Shipra, Ganga, and Triveni Sangam" },
    { value: "100%", label: "Pure A2 Desi Ghee Annakshetra", detail: "Vedic culinary kitchens with zero compromise on sanctity" }
  ],
  pillars: [
    {
      title: "Sanatan Reverence & Sovereign Dignity",
      description: "We view pilgrimage not as conventional commercial tourism, but as an ancient spiritual tapasya. Every sanctuary is engineered to uphold absolute dignity, sanctity, and peace for seekers and revered spiritual leaders."
    },
    {
      title: "Turnkey Flood-Plain Engineering Mastery",
      description: "Over 25 years, our in-house civil and structural teams have pioneered rapid-deployment weather-resistant canvas architecture with full underground sanitation, electrification, and acoustic insulation on raw riverbanks."
    },
    {
      title: "Uncompromising Pure Sattvic Bhojan",
      description: "Our Annakshetra kitchens adhere strictly to Vedic culinary shastras: 100% pure Gir cow A2 bilona ghee, zero onion or garlic, and dedicated Jain Chauvihar timings before sunset."
    },
    {
      title: "Senior Citizen Dignity & Step-Free Care",
      description: "We design every meter of our grounds with elder accessibility: non-slip timber boardwalks, on-demand electric golf cart mobility, private ghat corridors, and 24/7 on-site medical triage."
    }
  ]
};
