...
const HERO_SLIDES = [
  {
    ...
    badge: 'RAAMVAN RETREATS · RIVERFRONT CAMPUS',
    ...
    caption: 'Kumbh Cottages Riverfront · Saffron Flags & Holy River Fountain',
  ...
  },
  {
    ...
    subtitle: 'At dusk the campus glows — fairy-lit pathways, vibrant tents, and the calm of devotion under an open sky.',
    caption: 'Kumbh Cottages Campus · Fairy Lit Night View',
  ...
  },
  {
    ...
    badge: 'KUMBH COTTAGES™ · RAAMVAN RETREATS',
    ...
    caption: 'Kumbh Cottages™ · Daylight Campus with Brand Signage',
  ...
  },
  {
    ...
    caption: 'Elevated Riverbank Campus · Kumbh Canvas Villas',
  ...
  },
  {
    ...
    caption: 'Kumbh Cottages · Swiss Canvas Suites & Private Boardwalk',
    objectPosition: 'center 40%',
    kenBurnsDir: 'right',
  },
];
