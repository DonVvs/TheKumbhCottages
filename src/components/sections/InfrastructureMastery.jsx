...
export default function InfrastructureMastery({ onOpenInquiry }) {
  return (
    <section className="py-20 sm:py-24 bg-[#0D0A08] text-white border-b border-white/10 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-14 sm:mb-16">
          ...
          <h2 className="font-serif text-2xl sm:text-3xl lg:text-4xl font-light text-white leading-[1.2] tracking-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10 mb-14">
          {INFRASTRUCTURE_CAPABILITIES.map((cap, idx) => (
            <div
              key={cap.id}
              className="p-8 rounded-lg bg-white/[0.02] border border-white/10 hover:border-swarna-400/40 transition-colors flex flex-col justify-between space-y-6"
            >
              <div className="space-y-4">
                <div className="flex items-center justify-between pb-3 border-b border-white/10">
                  ...
                  <span className="font-mono text-xs text-stone-300 bg-white/5 px-2.5 py-0.5 rounded border border-white/10">
                    {cap.stats}
                  </span>
                </div>
                ...
                <div className="space-y-1.5 pt-3 border-t border-white/5 text-xs text-stone-400 font-sans font-light">
        ...
        <div className="bg-gradient-to-r from-stone-900 to-[#16110D] p-8 sm:p-10 rounded-lg border border-swarna-400/30 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 shadow-xl">
          ...
          <button
            ...
            className="px-6 py-3 rounded bg-swarna-400 text-stone-950 hover:bg-swarna-300 transition-colors text-xs uppercase tracking-wider font-medium flex-shrink-0 shadow-xs"
          >
